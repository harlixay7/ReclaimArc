...
pub enum Event {
    ...
    Analyzed { archive: PathBuf, plan_bytes: String },
    ...
    /// The job finished.
    JobFinished { job_id: String, committed_bytes: u64, reclaimed_bytes: u64 },
    ...
    EntrySkipped { index: u64, name: String, reason: String },
